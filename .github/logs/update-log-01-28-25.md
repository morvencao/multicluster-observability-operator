### Generated logs from GitHub Action: [13004822241](https://github.com/morvencao/multicluster-observability-operator/actions/runs/13004822241)
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20250128054916-3171b6dcb83e), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20250128054916-3171b6dcb83e), but does not contain package github.com/openshift/hypershift/api/v1beta1
